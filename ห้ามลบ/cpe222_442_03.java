...
public class cpe222_442_03 {
    public static void main(String[] args){
        ...
        System.out.println("Enter Exchange tyoe (1,2,3)");   
        Scanner scan = new Scanner(System.in);
        int bank = scan.nextInt();
        switch(bank){
            case 1:
            System.out.println("Input the price of THB");
            Double thb = scan.nextDouble();
            calMoney(thb);
            break;

            case 2:
            System.out.println("Input the price of USD and JPY");
            ...
            case 3:
            System.out.println("Input the price of USD , GBP and JPY");
    ...
    public static void calMoney(Double usd,Double gbp,Double jpy1){
        System.out.println("USD to THB = "+usd*31.85+" / GBP to THB = "+gbp*42.54+" / JPY to THB = "+jpy1*0.2878);
    }
