...
/**
 * ตัวอย่างการนำโค้ดจาก Quiz 7 (Q07_StringOperations) มาดัดแปลง (Edit)
 * สำหรับการสอบ
 * สมมติโจทย์สอบคือ: "จงนับจำนวนสระ (A, E, I, O, U) ทั้งพิมพ์เล็ก/ใหญ่
 * และหาผลรวมของ 'เลขคี่' จากข้อความ"
 * 
